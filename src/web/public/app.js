...
const PROVIDER_META = {
  ...
  ollama:         { icon: '🟣', label: 'Ollama', needsKey: false, hasBaseUrl: true, hasApiVersion: false, defaultUrl: 'http://localhost:11434' },
  lmstudio:       { icon: '🩵', label: 'LM Studio', needsKey: false, hasBaseUrl: true, hasApiVersion: false, defaultUrl: 'http://localhost:1234' },
